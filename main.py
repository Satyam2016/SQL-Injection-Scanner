...
def get_all_forms(url):
    ...
    # extracts all HTML form tags from it, and then return them (as a list):
...
def get_form_details(form):
    ...
    for input_tag in form.find_all("input"):
        ...
        #This line retrieves the value of the "type" attribute of the current <input> tag. If the "type" attribute is not present, it defaults to the string "text". This is useful for determining the type of the input field, such as "text", "password", "checkbox", etc.
        input_name = input_tag.attrs.get("name")
        input_value = input_tag.attrs.get("value", "")
        #This line appends a dictionary to the inputs list. The dictionary contains the type, name, and value of the input field.
